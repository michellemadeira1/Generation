package com.Game.Crud.lojagame.controller;
...
import com.Game.Crud.lojagame.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	public ResponseEntity<List<CategoriaModel>> findByNome(@PathVariable String nome){
